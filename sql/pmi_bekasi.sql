...
(1, 'Bekasi', '(021) 3906666', 'Jl. Kramat Raya No.47, RT.3/RW.4, Kramat, Kec. Senen, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10450');
...
(1, 'Alif Maulidanar', 'A', 'Male', 20, '60', 'adadada', 'adadad');
...
(1, 'RS Bekasi', '3144989', 'JL H.O.S COKROAMINOTO 31-33'),
(2, 'RS Jakasampurna', '082114735105', 'Citra Garden City Jakarta Jl. Boulevard G1 no 1 Citra 5 Jakarta Barat 11830');
...
--
ALTER TABLE `tb_distribusi_darah`
  MODIFY `nomor_distribusi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tb_pendonor`
--
ALTER TABLE `tb_pendonor`
  MODIFY `id_pendonor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `tb_rekam_medis`
--
ALTER TABLE `tb_rekam_medis`
  MODIFY `nomor_rekam_medis` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
